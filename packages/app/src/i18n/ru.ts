export const dict = {
  ...
  "settings.integrations.description":
    "Подключение переиспользуемых скиллов и серверов Model Context Protocol. Изменения сохраняются для этого экземпляра NovaClaw и загружаются в новые ходы агента.",
  "settings.integrations.skills.title": "Источники скиллов",
  "settings.integrations.skills.description": "Добавьте локальный каталог или HTTP(S)-репозиторий с пакетами SKILL.md.",
  "settings.integrations.skills.empty": "Дополнительные источники скиллов не подключены.",
  "settings.integrations.skills.source": "Источник скиллов",
  "settings.integrations.skills.placeholder": "/путь/к/skills или https://example.com/skills/",
  "settings.integrations.skills.add": "Подключить скиллы",
  "settings.integrations.skills.error.empty": "Укажите каталог скиллов или URL.",
  "settings.integrations.skills.error.duplicate": "Этот источник скиллов уже подключён.",
  "settings.integrations.skills.toast.failed": "Не удалось сохранить источники скиллов",
  "settings.integrations.skills.confirm.title": "Отключить этот источник скиллов?",
  "settings.integrations.skills.confirm.description":
    "NovaClaw прекратит поиск скиллов в «{{source}}». Файлы источника удалены не будут.",
  "settings.integrations.mcp.title": "Серверы MCP",
  "settings.integrations.mcp.description":
    "Добавьте локальную команду или удалённый HTTP-адрес. Включённые серверы подключаются к сессиям агента автоматически; команда /mcp показывает текущий статус в чате.",
  "settings.integrations.mcp.empty": "Серверы MCP не настроены.",
  "settings.integrations.mcp.name": "имя сервера (строчный slug)",
  "settings.integrations.mcp.local": "Локальная команда",
  "settings.integrations.mcp.remote": "Удалённый URL",
  "settings.integrations.mcp.local.placeholder": '["команда", "аргумент1", "аргумент2"]',
  "settings.integrations.mcp.remote.placeholder": "https://mcp.example.com/",
  "settings.integrations.mcp.add": "Подключить MCP",
  "settings.integrations.mcp.error.name": "Имя: строчные a-z, 0-9, -, _, не более 64 символов.",
  "settings.integrations.mcp.error.duplicate": "Сервер MCP с таким именем уже существует.",
  "settings.integrations.mcp.error.local": "Введите непустой JSON-массив аргументов команды.",
  "settings.integrations.mcp.error.remote": "Введите корректный HTTP- или HTTPS-адрес.",
  "settings.integrations.mcp.toast.failed": "Не удалось сохранить сервер MCP",
  "session.providerRecovery.title": "Предыдущий ответ модели был прерван",
  "session.providerRecovery.description":
    "Частичный ответ сохранён. Когда будете готовы, продолжите из надёжной истории.",
  "session.providerRecovery.toolDescription":
    "До остановки NovaClaw мог запуститься инструмент. Проверьте его цель перед повторением действия.",
  "session.providerRecovery.resume": "Безопасно продолжить",
  "session.providerRecovery.resuming": "Продолжаю…",
  "session.providerRecovery.error": "Не удалось продолжить сессию",
  "session.runtimeGuard.title": "Сессия остановлена ограничителем runtime",
  "session.runtimeGuard.inbox": "Дождитесь обработки существующей очереди перед отправкой нового сообщения.",
  "session.runtimeGuard.resume": "Продолжить",
  "session.runtimeGuard.resuming": "Продолжаю…",
  "session.runtimeGuard.error": "Не удалось продолжить сессию",
  ...
  "settings.recovery.watchdog.toast.failed": "Не удалось сохранить настройки контроля провайдера",
  "settings.recovery.watchdog.enabled.title": "Контроль зависания провайдера",
  "settings.recovery.watchdog.enabled.description":
    "Прерывать запрос, если провайдер замолчал или превысил общий лимит времени, затем запускать ограниченное восстановление",
  "settings.recovery.watchdog.inactivity.title": "Максимальная тишина (мс)",
  "settings.recovery.watchdog.inactivity.description":
    "Допустимый интервал между событиями стрима до признания соединения зависшим",
  "settings.recovery.watchdog.absolute.title": "Максимальное время запроса (мс)",
  "settings.recovery.watchdog.absolute.description":
    "Жёсткий лимит одного запроса; подберите его под модель и оборудование",
  "settings.recovery.guards.toast.failed": "Не удалось сохранить ограничения runtime",
  "settings.recovery.guards.enabled.title": "Ограничения объёма работы",
  "settings.recovery.guards.enabled.description":
    "Ограничивать объём работы отдельно от транспортных таймаутов провайдера; отключать защиту не рекомендуется",
  "settings.recovery.guards.turn.title": "Tool calls на запрос провайдера",
  "settings.recovery.guards.turn.description": "Остановиться до локального выполнения вызова сверх этого лимита",
  "settings.recovery.guards.drain.title": "Tool calls на Session drain",
  "settings.recovery.guards.drain.description": "Остановить многошаговый drain после этого общего числа вызовов",
  "settings.recovery.guards.inbox.title": "Ожидающие входные сообщения",
  "settings.recovery.guards.inbox.description": "Отклонять новые durable inputs при заполнении очереди сессии",
  "settings.recovery.guards.output.title": "Байты streamed output",
  "settings.recovery.guards.output.description":
    "Остановить запрос после этого объёма UTF-8 текста, reasoning и tool input",
